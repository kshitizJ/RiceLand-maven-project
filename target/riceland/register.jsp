            ...
            <div class="container d-flex justify-content-center align-items-center">
               <div class="row">
                  ...
                  <div class="col-lg-6 col-12 d-flex justify-content-center align-items-center">
                     <form onsubmit="return validation()" class="needs-validation" novalidate method="post"
                        action="UserServlet">
                        <div class="form-row">
                           ...
                           <div class="form-group col-md-6">
                              <label for="number">Mobile Number</label> <input type="text" class="form-control"
                                 id="number" name="number" placeholder="Mobile Number" required>
                              <div class="invalid-feedback">Please enter mobile number.</div>
                           </div>
                           <div class="form-group col-md-6">
                              <label for="cpass">Confirm Password</label> <input type="password" class="form-control"
                        ...
                        <div class="form-group">
                           <label for="address">Address</label> <input type="text" class="form-control" id="address"
                              name="address" placeholder="Apartment, studio, or floor" required>
                           <div class="invalid-feedback">Please enter your address.</div>
                        </div>
                        <div class="form-row">
                           <div class="form-group col-md-5">
                              <label for="state">State</label> <input type="text" class="form-control" id="state"
                           ...
                           <div class="form-group">
                              <div class="form-check">
                                 <input class="form-check-input" type="checkbox" value="" id="tandc" required> <label
                                    class="form-check-label" for="tandc"> Agree to terms and conditions </label>
